...
use produk as GlobalProduk;
    ...
    $produk = new Komik("One Piece", "Eichiro Oda", "Shonen Jump", 50000, 100, 0) ;

    $produkBaru = new Game("Uncharted", "Neil Druckmann", "Sony Computer", 250000, 0, 50) ;
    ...
    $produkBaru->setDiskon(50);
    echo $produkBaru->getHarga();
?>
